            ...
            <ul className="space-y-2">
              {programLinks.map(({ href, label }) => (
                <li key={href}>
                  <Link
                    href={href}
                    className="text-sm text-cream/70 transition-colors duration-150 hover:text-cream focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber active:text-cream/90"
                  >
                    {label}
                  </Link>
                </li>
        ...
        <div className="mt-12 border-t border-cream/10 pt-8">
          <div className="flex flex-col items-center justify-between gap-4 text-sm sm:flex-row">
            ...
            <p className="text-xs text-cream/30">
              A faith-based homesteading ministry
            </p>
          </div>
        </div>
      </div>
